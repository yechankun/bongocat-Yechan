...
namespace osu {
Json::Value left_key_value, right_key_value, key3, key4, key5, key6, smoke_key_value, wave_key_value, sunglass_key_value, dance_key_value, mirrorball_key_value;
...
sf::Sprite bg, up, left, right, device, smoke, wave, sunglass, sunglass_r;
